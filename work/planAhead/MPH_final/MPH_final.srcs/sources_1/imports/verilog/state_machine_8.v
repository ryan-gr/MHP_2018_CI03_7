  ...
  always @* begin
    ...
    case (M_state_q)
      ...
      AUTO_state: begin
        ...
        if (input_bit1 & input_bit2 & input_bit3) begin
          M_display_value_d = 16'h2111;
        end else begin
          if (input_bit1 & input_bit2) begin
            M_display_value_d = 16'h2110;
          end else begin
            if (input_bit1 & input_bit3) begin
              M_display_value_d = 16'h2101;
            end else begin
              if (input_bit2 & input_bit3) begin
                M_display_value_d = 16'h2011;
              end else begin
                if (input_bit1) begin
                  M_display_value_d = 16'h2100;
                end else begin
                  if (input_bit2) begin
                    M_display_value_d = 16'h2010;
                  end else begin
                    if (input_bit3) begin
                      M_display_value_d = 16'h2001;
                    end else begin
                      M_display_value_d = 16'h2000;
                    end
                  end
                end
              end
